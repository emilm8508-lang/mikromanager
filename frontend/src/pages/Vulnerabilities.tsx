    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button size="sm" variant="primary" onClick={() => run.mutate()} disabled={data.in_progress || run.isPending}>
            <RefreshCw size={13} className={data.in_progress ? 'animate-spin' : ''} />
            {data.in_progress ? t('vuln.scanning') : t('vuln.scanNow')}
          </Button>
        </div>
      </CardHeader>
